	...
	<div id="mws-header" class="clearfix">
    	...
    	<div id="mws-logo-container">
        	...
        	<div id="mws-logo-wrap">
                <span style="font-size:30px;color:white">后台管理</span>
			</div>
        </div>
        ...
        <div id="mws-sidebar">
            ...
            <div id="mws-navigation">
                <ul>
                    ...
                    <li>
                        <a href="#"><i class="icon-shopping-cart"></i> 购物车管理</a>
                        <ul class="closed">
                            <li><a href="/admin/goods/add"></a></li>
                            <li><a href="/admin/goods/index"></a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="#"><i class="icon-phone"></i> 订单管理</a>
                        <ul class="closed">
                            <li><a href="/admin/goods/add"></a></li>
                            <li><a href="/admin/goods/index"></a></li>
                        </ul>
                    ...
                    <li>
                        <a href="#"><i class="icon-plane"></i> 收货地址管理</a>
                        <ul class="closed">
                            <li><a href="/admin/goods/add">商品添加</a></li>
                            <li><a href="/admin/goods/index">商品列表</a></li>
                        </ul>
